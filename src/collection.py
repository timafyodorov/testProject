...
def description_filter(transactions: list, word: str) -> list:
    """Данная функция принимает на вход список транзакций
    и слово, по которому нужно отфильтровать описания транзакций
    и вывести уже отфильтрованный список"""
...
def category_count(transactions: list, categories: list) -> dict:
    """Эта функция принимает список словарей с транзакциями и список с категориями описаний, она
    выводит сколько всего есть транзакций с данными описаниями"""
